...
public class UimgeAPPRNDLevel {
    private Cluster cluster;
    private Session session;
    private static final String INSERT_RND_LEVEL = "insert into groups.uimge_apprnd_level " +
            "(uid, " +
            "c101, " +
            "c102, " +
            "c103, " +
        ...
        try {
            for (Row row : resultSet) {
                ...
                if (counter % 1000000 == 0) {
                    System.out.println("uimge_apprnd_level: "+counter +
    ...
    public static void main(String[] args) {
        UimgeAPPRNDLevel client = new UimgeAPPRNDLevel();
